...
public class PotScreen extends AbstractContainerScreen<PotMenu> {
    private static final ResourceLocation TEXTURE =
            new ResourceLocation(Foodmania.MOD_ID, "textures/gui/pot_gui.png");
    ...
    protected void renderBg(PoseStack pPoseStack, float pPartialTick, int pMouseX, int pMouseY) {
        ...
        if(menu.isCrafting()) {
            blit(pPoseStack, x + 73, y + 33, 176, 0, menu.getScaledProgress(), 17);
        }
        if(menu.isCrafting()) {
            blit(pPoseStack, x + 73, y + 57, 200, 0, 28, 24);
        }
    }
