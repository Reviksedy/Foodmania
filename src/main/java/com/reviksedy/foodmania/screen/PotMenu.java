...
public class PotMenu extends AbstractContainerMenu {
    ...
    public PotMenu(int pContainerId, Inventory inv, BlockEntity entity, ContainerData data) {
        ...
        this.blockEntity.getCapability(CapabilityItemHandler.ITEM_HANDLER_CAPABILITY).ifPresent(handler -> {
            this.addSlot(new SlotItemHandler(handler, 0, 43, 20));
            this.addSlot(new SlotItemHandler(handler, 1, 33, 39));
            this.addSlot(new SlotItemHandler(handler, 2, 53, 39));
            this.addSlot(new ModResultSlot(handler, 3, 114, 31));
        });
