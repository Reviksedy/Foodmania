...
import com.reviksedy.foodmania.screen.slot.ModResultSlot;
...
public class GrillMenu extends AbstractContainerMenu {
    private final GrillBlockEntity blockEntity;
    private final Level level;
    private final ContainerData data;
    private final ContainerData data2;

    public GrillMenu(int pContainerId, Inventory inv, FriendlyByteBuf extraData) {
        this(pContainerId, inv, inv.player.level.getBlockEntity(extraData.readBlockPos()), new SimpleContainerData(2), new SimpleContainerData(2));
    }
    ...
    public int getScaledBurnTime() {
        int burnTime = this.data2.get(0);
        int maxBurnTime = this.data2.get(1);  // Max Progress
        int burnFireSize = 14; // This is the height in pixels of your arrow

        return maxBurnTime != 0 && burnTime != 0 ? burnTime * burnFireSize / maxBurnTime : 0;
    }
